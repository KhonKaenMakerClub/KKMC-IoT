...
import com.numberx.kkmctimer.provider.AlarmInstance;
import com.numberx.kkmctimer.provider.DaysOfWeek;
import com.numberx.kkmctimer.widget.ActionableToastBar;
import com.numberx.kkmctimer.widget.TextTime;
...
public class AlarmClockFragment extends DeskClockFragment implements
            ...
            protected Void doInBackground(Void... parameters) {
                ...
                if (context != null && alarm != null) {
                    ...
                    if ((bypassServer.length <= 0) || (!bypassServer[0]) ) {
                        newKKMCTimerSync().deleteServerAlarm(alarm);
                    }
        ...
        final AsyncTask<Void, Void, AlarmInstance> updateTask =
            ...
            protected AlarmInstance doInBackground(Void... parameters) {
                if (context != null && alarm != null) {
                    ...
                    if ((bypassServer.length <= 0) || (!bypassServer[0]) ) {
                        newKKMCTimerSync().addServerAlarm(alarm);
                    }
    ...
    protected void asyncUpdateAlarm(
        ...
        final AsyncTask<Void, Void, AlarmInstance> updateTask =
            ...
            protected AlarmInstance doInBackground(Void ... parameters) {
                ...
                // argument in updateAlarm. Usually this is a request from KKMCTimer server.
                if (bypassServer.length > 0 && bypassServer[0]) {
                    Alarm.updateAlarm(cr, alarm, true);
                } else {
                    Alarm.updateAlarm(cr, alarm);
                    newKKMCTimerSync().editServerAlarm(alarm);
                }
    ...
    private KKMCTimerSync newKKMCTimerSync() {
        return new KKMCTimerSync(getActivity(), this.getTag());
    }
}
