...
import com.numberx.kkmctimer.alarms.AlarmNotifications;
import com.numberx.kkmctimer.topic.SensorAdapter;
import com.numberx.kkmctimer.widget.TextClock;
import com.numberx.kkmctimer.worldclock.WorldClockAdapter;
...
public class ClockFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new SensorAdapter(getActivity());
    ...
    public void onResume () {
        ...
        if (mAdapter != null) {
            mAdapter.loadTopicsDb(activity);
