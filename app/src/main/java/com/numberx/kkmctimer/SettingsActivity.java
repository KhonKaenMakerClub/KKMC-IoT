...
public class SettingsActivity extends PreferenceActivity
    ...
    // KKMCTimer settings keys
    public static final String KEY_NETPIE_SERVER =
            "kkmctimer_server";
    public static final String KEY_NETPIE_REST =
            "kkmctimer_restkey";
    public static final String KEY_NETPIE_APPID =
            "kkmctimer_appid";
    public static final String KEY_KKMCTIMER_KEEP_NEW =
            "kkmctimer_keep_new_alarms";
    public static final String PAYLOAD_PUSH =
            "kkmctimer_push_payload";
    public static final String PAYLOAD_ONOFF =
            "kkmctimer_onoff_payload";
    ...
    public boolean onPreferenceChange(Preference pref, Object newValue) {
        ...
        if (KEY_AUTO_SILENCE.equals(pref.getKey())) {
            ...
            final int idx = listPref.findIndexOfValue((String) newValue);
            listPref.setSummary(listPref.getEntries()[idx]);
        } else if (KEY_NETPIE_SERVER.equals(pref.getKey()) || KEY_NETPIE_REST.equals(pref.getKey()) || KEY_NETPIE_APPID.equals(pref.getKey())) {
            final EditTextPreference textPref = (EditTextPreference) pref;
            textPref.setSummary((String) newValue);
        } else if (PAYLOAD_ONOFF.equals(pref.getKey())) {
            final EditTextPreference textPref = (EditTextPreference) pref;
            textPref.setSummary((String) newValue + "  ,(On:Off) Separate by ':'");
        }else if (PAYLOAD_PUSH.equals(pref.getKey())) {
            final EditTextPreference textPref = (EditTextPreference) pref;
            textPref.setSummary((String) newValue);
        }
        else if (KEY_KKMCTIMER_KEEP_NEW.equals(pref.getKey())) {
            boolean state =((CheckBoxPreference) pref).isChecked();
    ...
    private void refresh() {
        ...
        EditTextPreference piServerPref = (EditTextPreference)findPreference(KEY_NETPIE_SERVER);
        piServerPref.setSummary(piServerPref.getText());
        piServerPref.setOnPreferenceChangeListener(this);

        EditTextPreference piRestPref = (EditTextPreference)findPreference(KEY_NETPIE_REST);
        piRestPref.setSummary(piRestPref.getText());
        piRestPref.setOnPreferenceChangeListener(this);

        EditTextPreference piAppidPref = (EditTextPreference)findPreference(KEY_NETPIE_APPID);
        piAppidPref.setSummary(piAppidPref.getText());
        piAppidPref.setOnPreferenceChangeListener(this);

        EditTextPreference piPushPayloadPref = (EditTextPreference)findPreference(PAYLOAD_PUSH);
        piPushPayloadPref.setSummary(piPushPayloadPref.getText());
        piPushPayloadPref.setOnPreferenceChangeListener(this);

        EditTextPreference piOnOffPayloadPref = (EditTextPreference)findPreference(PAYLOAD_ONOFF);
        piOnOffPayloadPref.setSummary(piOnOffPayloadPref.getText());
        piOnOffPayloadPref.setOnPreferenceChangeListener(this);

        Preference piKeepPref = findPreference(KEY_KKMCTIMER_KEEP_NEW);
