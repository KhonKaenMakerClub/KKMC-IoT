...
public final class AlarmInstance implements ClockContract.InstancesColumns {
    ...
    private static final int KKMCTIMER_ID_INDEX = 11;
    ...
    public static ContentValues createContentValues(AlarmInstance instance) {
        ...
        values.put(KKMCTIMER_ID, instance.mLightuppiId);
    ...
    /**
     * Get an alarm instances by KKMCTimer alarm ID.
     *
     * @param contentResolver to perform the query on.
     * @param kkmctimerId ID of the KKMCTimer alarm instances desired.
     * @return list of alarms instances that have the KKMCTimer ID.
     */
    public static List<AlarmInstance> getInstancesByLightuppiId(ContentResolver contentResolver,
                                                            long kkmctimerId) {
        return getInstances(contentResolver, KKMCTIMER_ID + "=" + kkmctimerId);
    }
    ...
    public AlarmInstance(Cursor c) {
        ...
        if (!c.isNull(KKMCTIMER_ID_INDEX)) {
            mLightuppiId = c.getLong(KKMCTIMER_ID_INDEX);
        }
