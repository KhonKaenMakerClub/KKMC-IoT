...
public class ClockDatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * 1: Added KKMCTimer alarm ID to alarms table.
     * 2: Added timestamp to the alarms table.
     */
    private static final int VERSION_KKMCTIMER_1 = 10;
    private static final int VERSION_KKMCTIMER_2 = 11;
    ...
    private static void createAlarmsTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.KKMCTIMER_ID + " INTEGER NOT NULL," +
    ...
    private static void createInstanceTable(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " (" +
                ...
                ClockContract.InstancesColumns.KKMCTIMER_ID + " INTEGER NOT NULL, " +
    ...
    private static void insertDefaultAlarms(SQLiteDatabase db) {
        ...
        String insertMe = "INSERT INTO " + ALARMS_TABLE_NAME + " (" +
                ...
                ClockContract.AlarmsColumns.KKMCTIMER_ID + cs +
    ...
    public ClockDatabaseHelper(Context context) {
        super(context, DATABASE_NAME, null, VERSION_KKMCTIMER_2);
        mContext = context;
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
        ...
        if (oldVersion < VERSION_KKMCTIMER_2) {
