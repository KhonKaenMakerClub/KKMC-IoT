...
/**
 * Class to measure and draw the time in the {@link com.numberx.kkmctimer.CircleTimerView}.
...
public class CountingTimerView extends View {
     ...
     * {@link com.numberx.kkmctimer.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
